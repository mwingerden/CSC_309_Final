...
/**
 * The com.tests.Repository class holds all the needed information of other classes.
 *
 * @author  Nathon Ho
...
public class Repository extends Observable {
    ...
    public void saveList() throws IOException {
        String name = (String) JOptionPane.showInputDialog(
                new WorkSpace(),
                "Type Name for the com.tests.Save File:",
                "com.tests.Save File",
    ...
    public void loadList() {
        String name = (String) JOptionPane.showInputDialog(
                new WorkSpace(),
                "Enter Name to com.tests.Load File:",
                "Enter Name",
                JOptionPane.PLAIN_MESSAGE,
                null,
                null,
    ...
    /**
     * addArrow method used by the com.tests.MainController to add arrows between blocks.
