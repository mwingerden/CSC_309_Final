...
/**
 * The com.tests.ConditionBlock class represented by a diamond shape when drawn by the user.
 */
public class ConditionBlock extends Block{
    /**
     * com.tests.ConditionBlock constructor taking in the necessary parameters.
    ...
    /**
     * com.tests.Draw method uses abstract class graphics 2D to draw the diamond block.
     * @param g, Graphics
     */
    @Override
