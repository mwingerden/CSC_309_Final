...
public class VariableDeclarationBlock extends Block{
    ...
    /**
     * draw method used to create the com.tests.VariableDeclarationBlock rectangle.
    ...
    /**
     * The getter methods returning the centered x and y coordinates of the com.tests.VariableDeclarationBlock.
