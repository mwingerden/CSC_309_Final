...
public class ParserTest {
    ...
    public void testVariables1(){
        ...
        assertEquals(((VariableDeclarationBlock) p.get_blocks().get(1)).getText(), "int i");
        assertTrue(p.get_blocks().get(2) instanceof InstructionBlock);
        assertEquals(((InstructionBlock) p.get_blocks().get(2)).getText(), "i = 0");
    ...
    public void testForBlock1(){
        ...
        assertEquals(((InstructionBlock) p.get_blocks().get(4)).getText(), "i++");
